...
// DEBUGGING: Simplified ProgressTab to isolate iframe issues
...
const ProgressTab = () => {
  // DEBUGGING: Simplified to just show success message
  ...
  return (
    <div style={{ padding: '20px', textAlign: 'center', fontSize: '24px', fontWeight: 'bold', color: '#28a745' }}>
      Progress page iframed successfully
    </div>
  );

  // DEBUGGING: Original component code commented out
  // return (
  //   <>
  //     <ProgressHeader />
